import logo from '../assets/carton-svgrepo-com.svg';
        ...
        <>
            <footer className="w-full bg-gray-100 py-4">
                <div className="w-full flex items-center justify-center gap-4">
                    ...
                    />
                    <p className='text-lg font-medium text-gray-500 m-0'>
                        AES encryption project
                    </p>
                </div>
                <div>
                    <p className="mx-auto mt-6 max-w-md text-center leading-relaxed text-gray-500">
                        A Mahiro-RuisoArt software project. Visit the associated GitHub repository.
                    </p>
                </div>
